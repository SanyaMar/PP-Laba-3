...
class Window(QMainWindow):
    ...
    def message(self, text: str) -> None:
        ...
        Функция принимает str, которая выводится в окне.
        """
        dlg = QDialog(self)
        dlg.setWindowTitle("Images Cats and Dogs")
    ...
    def add_menu_bar(self) -> None:
        ...
        self.change_action = QAction(
            QIcon("icon/blue-folder.png"), "&Change dataset")
